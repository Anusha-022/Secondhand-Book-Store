...
<section class="py-4">
    <div class="container px-4 px-lg-5 my-5">
        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-4">
                <img class="card-img-top w-100 book-cover mb-5 mb-md-0 " loading="lazy" id="display-img" src="<?php echo validate_image($img) ?>" alt="..." />
                <div class="mt-2 row gx-2 gx-lg-3 row-cols-4 row-cols-md-3 row-cols-md-4 justify-content-start">
                    <?php 
            ...
            <div class="col-md-6">
                ...
                <div class="fs-5 mb-5">
                Rs. <span id="price"><?php echo number_format($inv[0]['price']) ?></span>
                <br>
