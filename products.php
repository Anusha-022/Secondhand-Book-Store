    ...
    <div class="container-fluid row">
        ...
        <div class="<?php echo isset($_GET['c'])? 'col-md-9': 'col-md-10 offset-md-1' ?>">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <?php if(isset($_GET['c'])): ?>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="details-tab" data-toggle="tab" href="#details" role="tab" aria-controls="details" aria-selected="false"></a>
                </li>
                <?php endif; ?>
            </ul>
                    ...
                    <div class="row gx-2 gx-lg-2 row-cols-1 row-cols-md-3 row-cols-xl-3">
                        ...
                        <div class="col mb-5">
                            <div class="card product-item">
                                <!-- Product image-->
                                <a class=""   href=".?p=view_product&id=<?php echo md5($row['id']) ?>">
                                ...
                                <div class="product-content text-center">
                                    ...
                                    <?php foreach($inv as $k=> $v): ?>
                                    <span><b>Price: </b>Rs. <?php echo $v ?></span>
                                    <?php endforeach; ?>
                                </div>
                                </div>
                        <?php endwhile; ?>
